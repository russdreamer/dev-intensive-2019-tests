...
class DateTest {
    ...
    fun test_plural() {
        ...
        assertEquals("102 секунды", TimeUnits.SECOND.plural(112))
        ...
        assertEquals("102 минуты", TimeUnits.MINUTE.plural(112))
        ...
        assertEquals("102 часа", TimeUnits.HOUR.plural(112))
        ...
        assertEquals("102 дня", TimeUnits.DAY.plural(112))
        ...
        assertEquals("1234 дня", TimeUnits.DAY.plural(311))
    }
}